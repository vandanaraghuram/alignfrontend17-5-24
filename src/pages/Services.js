...
function Services() {
  return (
    <div className='services'  style={{ padding: '1rem 0' }}>
      <Header></Header>
      <h1 className='text-center bg-black p-5' style={{fontSize:'60px', color:'wheat', fontWeight:'700'}}>OUR SET OF SERVICES</h1>
      <Row className='p-5'>
        <Col className='md-4 lg-4 '>
          <Link className='text-decoration-none' to={'/display'}>
          <Card data-aos="zoom-in" data-aos-duration="1000" className='' style={{ width: '23rem', height:'41rem', backgroundColor:'#fcf6e1' }}>
        ...
        <Link className='text-decoration-none' to={'/display'}>
          <Card data-aos="zoom-in" data-aos-duration="1500" className='' style={{ width: '23rem', height:'41rem',backgroundColor:'#fcf6e1' }}>
        ...
        <Col className='md-4 lg-4' style={{paddingTop:'140px'}}>
          <Link className='text-decoration-none' to={'/display'}>
          <Card data-aos="zoom-in" data-aos-duration="2000" className='crd' style={{ width: '23rem', height:'41rem' ,backgroundColor:'#fcf6e1'}}>
...
<Row className='p-5'>
    ...
    <section class="faq-section py-5 bg-black text-light mt-5">
      ...
      <Accordion.Item eventKey="0" >
        <Accordion.Header style={{color:'wheat'}}>HOW MANY YEARS OF EXPERIENCE DOES YOUR FIRM HAVE?</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="1" className='mt-3' >
        <Accordion.Header style={{color:'wheat'}}>HOW BIF IS YOUR TEAM OF ARCHITECT?</Accordion.Header>
        <Accordion.Body>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
      ...
      <Accordion.Item eventKey="2" className='mt-3'>
        <Accordion.Header style={{color:'wheat'}}>HOE CAN I GET A QUOTE FOR MY PROJECT?</Accordion.Header>
        <Accordion.Body>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
      ...
      <Accordion.Item eventKey="3" className='mt-3' style={{color:'wheat'}}>
        <Accordion.Header style={{color:'wheat'}}>DOES YOUR FIRM HAVE A PROJECT MINIMUM?</Accordion.Header>
        <Accordion.Body>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
